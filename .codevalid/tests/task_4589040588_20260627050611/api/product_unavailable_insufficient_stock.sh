...
CASE_SUFFIX="$(date +%s)-$$"
BUYER_ID="buyer-low-stock-${CASE_SUFFIX}"
BUYER_EMAIL="buyer-low-stock-${CASE_SUFFIX}@example.com"
SELLER_USER_ID="seller-user-low-stock-${CASE_SUFFIX}"
SELLER_EMAIL="seller-low-stock-${CASE_SUFFIX}@example.com"
SELLER_ID="seller-low-stock-${CASE_SUFFIX}"
PRODUCT_ID="prod-low-stock-${CASE_SUFFIX}"
RESPONSE_FILE="/tmp/product_unavailable_insufficient_stock_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/product_unavailable_insufficient_stock_${CASE_SUFFIX}.status"
...
VALUES ('${SELLER_ID}','${SELLER_USER_ID}','Low Stock Store ${CASE_SUFFIX}');
INSERT INTO products (id, seller_id, title, description, category, price_cents, stock_qty, visible, status)
VALUES ('${PRODUCT_ID}','${SELLER_ID}','Low Stock Widget ${CASE_SUFFIX}','Low stock checkout product','widgets',500,2,TRUE,'ACTIVE');
SQL
...
echo "CODEVALID_TEST_ASSERTION_OK:product_unavailable_insufficient_stock"
