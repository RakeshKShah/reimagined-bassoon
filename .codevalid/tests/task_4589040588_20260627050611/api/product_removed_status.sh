...
CASE_SUFFIX="$(date +%s)-$$"
BUYER_ID="buyer-removed-${CASE_SUFFIX}"
BUYER_EMAIL="buyer-removed-${CASE_SUFFIX}@example.com"
SELLER_USER_ID="seller-user-removed-${CASE_SUFFIX}"
SELLER_EMAIL="seller-removed-${CASE_SUFFIX}@example.com"
SELLER_ID="seller-removed-${CASE_SUFFIX}"
PRODUCT_ID="prod-removed-${CASE_SUFFIX}"
RESPONSE_FILE="/tmp/product_removed_status_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/product_removed_status_${CASE_SUFFIX}.status"
...
VALUES ('${PRODUCT_ID}','${SELLER_ID}','Removed Widget ${CASE_SUFFIX}','Removed checkout product','widgets',1000,5,TRUE,'REMOVED');
SQL
...
echo "CODEVALID_TEST_ASSERTION_OK:product_removed_status"
