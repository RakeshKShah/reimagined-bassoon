...
CASE_SUFFIX="$(date +%s)-$$"
BUYER_ID="user-buyer-2-${CASE_SUFFIX}"
BUYER_EMAIL="buyer2-${CASE_SUFFIX}@example.com"
SELLER_USER_ID="user-seller-2-${CASE_SUFFIX}"
SELLER_EMAIL="seller2-${CASE_SUFFIX}@example.com"
SELLER_PROFILE_ID="seller-profile-2-${CASE_SUFFIX}"
PRODUCT_ID="prod-300-${CASE_SUFFIX}"
RESPONSE_FILE="/tmp/checkout_reject_out_of_stock_product_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/checkout_reject_out_of_stock_product_${CASE_SUFFIX}.status"
...
INSERT INTO "Product" (id, "sellerId", title, description, category, "priceCents", "stockQty", status, visible, "createdAt") VALUES
  ('$PRODUCT_ID', '$SELLER_PROFILE_ID', 'Sold Out ${CASE_SUFFIX}', 'Out of stock product', 'HOME', 800, 0, 'SOLD_OUT', true, NOW());
SQL
...
[ "$ORDER_COUNT" = "0" ]
echo "CODEVALID_TEST_ASSERTION_OK:checkout_reject_out_of_stock_product"
