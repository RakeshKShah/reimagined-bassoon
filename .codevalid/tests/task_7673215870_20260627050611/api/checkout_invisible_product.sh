...
CASE_SUFFIX="$(date +%s)-$$"
BUYER_ID="user-buyer-6-${CASE_SUFFIX}"
BUYER_EMAIL="checkout-hidden-${CASE_SUFFIX}@example.com"
SELLER_USER_ID="seller-user-6-${CASE_SUFFIX}"
SELLER_EMAIL="checkout-hidden-seller-${CASE_SUFFIX}@example.com"
SELLER_ID="seller-6-${CASE_SUFFIX}"
PRODUCT_ID="prod-hidden-77-${CASE_SUFFIX}"
RESPONSE_FILE="/tmp/checkout_invisible_product_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/checkout_invisible_product_${CASE_SUFFIX}.status"
...
INSERT INTO sellers (id, user_id, store_name) VALUES ('${SELLER_ID}','${SELLER_USER_ID}','Checkout Hidden Store ${CASE_SUFFIX}');
INSERT INTO products (id, seller_id, title, description, category, price_cents, stock_qty, visible, status)
VALUES ('${PRODUCT_ID}','${SELLER_ID}','Hidden ${CASE_SUFFIX}','Hidden checkout product','widgets',2500,10,FALSE,'ACTIVE');
SQL
...
echo "CODEVALID_TEST_ASSERTION_OK:checkout_invisible_product"
