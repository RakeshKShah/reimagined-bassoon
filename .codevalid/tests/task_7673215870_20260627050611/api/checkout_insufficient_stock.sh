...
CASE_SUFFIX="$(date +%s)-$$"
BUYER_ID="user-buyer-4-${CASE_SUFFIX}"
BUYER_EMAIL="checkout-insufficient-${CASE_SUFFIX}@example.com"
SELLER_USER_ID="seller-user-4-${CASE_SUFFIX}"
SELLER_EMAIL="checkout-insufficient-seller-${CASE_SUFFIX}@example.com"
SELLER_ID="seller-4-${CASE_SUFFIX}"
PRODUCT_ID="prod-limited-55-${CASE_SUFFIX}"
RESPONSE_FILE="/tmp/checkout_insufficient_stock_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/checkout_insufficient_stock_${CASE_SUFFIX}.status"
...
INSERT INTO sellers (id, user_id, store_name) VALUES ('${SELLER_ID}','${SELLER_USER_ID}','Checkout Limited Store ${CASE_SUFFIX}');
INSERT INTO products (id, seller_id, title, description, category, price_cents, stock_qty, visible, status)
VALUES ('${PRODUCT_ID}','${SELLER_ID}','Limited ${CASE_SUFFIX}','Limited stock product','widgets',1500,2,TRUE,'ACTIVE');
SQL
...
echo "CODEVALID_TEST_ASSERTION_OK:checkout_insufficient_stock"
