...
CASE_SUFFIX="$(date +%s)-$$"
BUYER_ID="user-buyer-8-${CASE_SUFFIX}"
BUYER_EMAIL="checkout-lastone-${CASE_SUFFIX}@example.com"
SELLER_USER_ID="seller-user-8-${CASE_SUFFIX}"
SELLER_EMAIL="checkout-lastone-seller-${CASE_SUFFIX}@example.com"
SELLER_ID="seller-8-${CASE_SUFFIX}"
PRODUCT_ID="prod-lastone-66-${CASE_SUFFIX}"
RESPONSE_FILE="/tmp/checkout_stock_sync_to_sold_out_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/checkout_stock_sync_to_sold_out_${CASE_SUFFIX}.status"
...
INSERT INTO sellers (id, user_id, store_name) VALUES ('${SELLER_ID}','${SELLER_USER_ID}','Checkout Last One Store ${CASE_SUFFIX}');
INSERT INTO products (id, seller_id, title, description, category, price_cents, stock_qty, visible, status)
VALUES ('${PRODUCT_ID}','${SELLER_ID}','Last One ${CASE_SUFFIX}','Sold out sync verification product','widgets',800,2,TRUE,'ACTIVE');
SQL
...
echo "CODEVALID_TEST_ASSERTION_OK:checkout_stock_sync_to_sold_out"
