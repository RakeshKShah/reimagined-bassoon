...
CASE_SUFFIX="$(date +%s)-$$"
BUYER_EMAIL="buyer-test-missing-${CASE_SUFFIX}@example.com"
PASSWORD="BuyerPass789!"
RESPONSE_FILE="/tmp/schema_validation_missing_fields_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/schema_validation_missing_fields_${CASE_SUFFIX}.status"
BUYER_FILE="/tmp/schema_validation_missing_fields_buyer_${CASE_SUFFIX}.json"
...
echo "CODEVALID_TEST_ASSERTION_OK:schema_validation_missing_fields"
